...
public class MusicService extends Service implements OnCompletionListener {
	...
	public void onCreate() {
		...
		quitPendingIntent = PendingIntent.getBroadcast(this, 0, new Intent("com.azad.musicplayer.quit"), 0);
		previousPendingIntent = PendingIntent.getBroadcast(this, 0, new Intent("com.azad.musicplayer.previous"), 0);
		playpausePendingIntent = PendingIntent.getBroadcast(this, 0, new Intent("com.azad.musicplayer.playpause"), 0);
		nextPendingIntent = PendingIntent.getBroadcast(this, 0, new Intent("com.azad.musicplayer.next"), 0);
		...
		intentFilter.addAction("com.azad.musicplayer.quit");
		intentFilter.addAction("com.azad.musicplayer.previous");
		intentFilter.addAction("com.azad.musicplayer.previousNoRestart");
		intentFilter.addAction("com.azad.musicplayer.playpause");
		intentFilter.addAction("com.azad.musicplayer.next");
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch(action) {
                    case "com.azad.musicplayer.quit":
                        sendBroadcast(new Intent("com.azad.musicplayer.quitactivity"));
                        sendBroadcast(new Intent(Intent.ACTION_CLOSE_SYSTEM_DIALOGS));
                        stopSelf();
                        return;
                    case "com.azad.musicplayer.previous":
                        previousItem(false);
                        break;
                    case "com.azad.musicplayer.previousNoRestart":
                        previousItem(true);
                        break;
                    case "com.azad.musicplayer.playpause":
                        playPause();
                        break;
                    case "com.azad.musicplayer.next":
                        nextItem();
                        break;
	...
	public boolean playItem(PlayableItem item, boolean startPlaying) {
		...
		try {
			...
			updateNotificationMessage();
			if(startPlaying) {
				sendBroadcast(new Intent("com.azad.musicplayer.newsong")); // Sends a broadcast to the activity
			}
	...
	public void playPause() {
		...
		updateNotificationMessage();
		sendBroadcast(new Intent("com.azad.musicplayer.playpausechanged"));
	}
	...
	public void nextItem() {
		...
		if(nextItem==null) {
            ...
            sendBroadcast(new Intent("com.azad.musicplayer.newsong")); // Notify the activity that there are no more songs to be played
            updateNotificationMessage();
		} else {
			playItem(nextItem);
		}
	...
	public static class MediaButtonReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE:
				context.sendBroadcast(new Intent("com.azad.musicplayer.playpause"));
				return;
			case KeyEvent.KEYCODE_MEDIA_PREVIOUS:
				context.sendBroadcast(new Intent("com.azad.musicplayer.previousNoRestart"));
				return;
			case KeyEvent.KEYCODE_MEDIA_NEXT:
				context.sendBroadcast(new Intent("com.azad.musicplayer.next"));
				return;
			}
		}
	}

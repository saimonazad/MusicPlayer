...
import com.azad.musicplayer.fragments.BrowserFragment;
import com.azad.musicplayer.fragments.MusicPlayerFragment;
import com.azad.musicplayer.fragments.PlaylistFragment;
import com.azad.musicplayer.fragments.PodcastsFragment;
import com.azad.musicplayer.fragments.RadioFragment;
import com.azad.musicplayer.models.BrowserDirectory;
import com.azad.musicplayer.models.BrowserSong;
import com.azad.musicplayer.models.Information;
...
import com.azad.musicplayer.ui.CheckableImageButton;
...
public class MainActivity extends AppCompatActivity implements OnClickListener, OnSeekBarChangeListener {
    ...
    public void onResume() {
    	...
    	intentFilter.addAction("com.azad.musicplayer.newsong");
    	intentFilter.addAction("com.azad.musicplayer.playpausechanged");
    	intentFilter.addAction("com.azad.musicplayer.podcastdownloadcompleted");
    	intentFilter.addAction("com.azad.musicplayer.quitactivity");
        broadcastReceiver = new BroadcastReceiver() {
            @Override
            public void onReceive(Context context, Intent intent) {
            	if(intent.getAction().equals("com.azad.musicplayer.newsong")) {
            		updatePlayingItem();
            	} else if(intent.getAction().equals("com.azad.musicplayer.playpausechanged")) {
            		updatePlayPauseButton();
            	} else if(intent.getAction().equals("com.azad.musicplayer.podcastdownloadcompleted")) {
            	...
            	} else if(intent.getAction().equals("com.azad.musicplayer.quitactivity")) {
